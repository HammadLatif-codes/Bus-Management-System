...
<body class="p-3 mb-2 bg-dark text-white">
    ...
    <h2 class="d-flex justify-content-center pb-4 pt-2">Search Vehicle </h2>
    <form>
        ...
        <div class="form-group row mb-0 ">
            ...
            <div class="col-lg-4 pb-4 pl-4">
                <!-- pd to separate col-2 from under row AND pl to push col-2 to right-->
                <p>Search Vehicle whose schedule you want to update</p>
        ...
        <div class="form-group row mb-0 ">
            ...
            <div class="col-lg-4  pl-5">
                <div class="pl-5"> <a href="./add_Vehicle_s.html" class="link-warning">Delete Vehicle Schedule</a></div>
        ...
        <div class="form-group row mb-0 ">
            ...
            <div class="col-lg-2  pb-3">
                <a href="./add_Vehicle_s.html" class="link-warning">Update Vehicle Schedule</a>
            </div>
            <div class="col-lg-1 pt-0">
                <!-- empty div to add space b/w col-2 and col-4-->
            </div>
            ...
            <div class="col-lg-4  ">
                ...
                <a href="./add_Vehicle_s.html" class="link-warning">View Vehicle Schedule</a>
            </div>
        </div>
        ...
        <div class="form-group row mb-0 ">
            ...
            <div class="col-lg-2  pt-4">
                <a href="./add_Vehicle_s.html" class="link-warning">View Requisition</a>
            </div>
            <div class="col-lg-1 pt-0">
                <!-- empty div to add space b/w col-2 and col-4-->
            </div>
            <div class="col-lg-4 pb-4 pl-4 pt-4">
                <!-- pd to separate col-2 from under row AND pl to push col-2 to right-->
            ...
            <div class="col-lg-4  pt-4 ">
                ...
                <a href="./add_Vehicle_s.html" class="link-warning"> Give Requisition Response</a>
            </div>
        </div>
        ...
        <div class="form-group row mb-0 ">
            ...
            <div class="col-lg-2  pt-3">
                <a href="./add_Vehicle_s.html" class="link-warning">View Complaints</a>
            </div>
            <div class="col-lg-1 pt-0">
                <!-- empty div to add space b/w col-2 and col-4-->
            </div>
            ...
            <div class="col-lg-4  ">
                <button type="button" class="btn btn-secondary" id="btn3">search</button>
                <a href="./add_Vehicle_s.html" class="link-warning">View Vehicle Status</a>
            </div>
        </div>
        ...
        <div class="form-group row mb-0 ">
            ...
            <div class="col-lg-4 pt-0 pb-4">
            <!-- <a href="./add_Vehicle_s.html" class="link-warning">View Vehicle Status</a> -->

               
            </div>
            <div class="col-lg-4 pt-0 pl-5 pt-4">
            <a  href="./add_Vehicle_s.html" class="link-warning pl-5">Logout</a>
